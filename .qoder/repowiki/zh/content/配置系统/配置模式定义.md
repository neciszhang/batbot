...
**更新** 本版本反映了LLM提供者配置参数的重大变更，包括maxTokens到max_completion_tokens的迁移，以及reasoningEffort枚举值的扩展，同时更新了模块导入以使用Node.js内置模块前缀，提高了代码的兼容性和可维护性。
...
**章节来源**
- [schema.ts:1-149](file://src/config/schema.ts#L1-L149)
- [index.ts:1-3](file://src/config/index.ts#L1-L3)
- [loader.ts:1-30](file://src/config/loader.ts#L1-L30)
...
**章节来源**
- [schema.ts:5-149](file://src/config/schema.ts#L5-L149)
...
**章节来源**
- [schema.ts:52-54](file://src/config/schema.ts#L52-L54)
...
**章节来源**
- [schema.ts:70-74](file://src/config/schema.ts#L70-L74)
...
**章节来源**
- [schema.ts:58-66](file://src/config/schema.ts#L58-L66)
...
**章节来源**
- [schema.ts:111-117](file://src/config/schema.ts#L111-L117)
...
**章节来源**
- [schema.ts:85-88](file://src/config/schema.ts#L85-L88)
...
**章节来源**
- [schema.ts:78-81](file://src/config/schema.ts#L78-L81)
...
**章节来源**
- [schema.ts:92-95](file://src/config/schema.ts#L92-L95)
...
**章节来源**
- [schema.ts:99-107](file://src/config/schema.ts#L99-L107)
...
**章节来源**
- [schema.ts:121-129](file://src/config/schema.ts#L121-L129)
...
**章节来源**
- [schema.ts:133-148](file://src/config/schema.ts#L133-L148)
...
- 工作区路径解析异常
  ...
  - 参考
    - [schema.ts:140-147](file://src/config/schema.ts#L140-L147)
- 配置字段类型不匹配
  - 现象：运行时报类型错误或字段缺失。
...
- **更新** LLM配置参数问题
  ...
  - 参考
    ...
    - [base.ts:4-8](file://src/providers/base.ts#L4-L8)
- 模块导入问题
...
**更新** 最新的模块导入变更采用了 Node.js 内置模块前缀，提高了代码的兼容性和可维护性，同时保持了原有的功能完整性。LLM提供者配置参数的更新（maxTokens到max_completion_tokens的迁移和reasoningEffort枚举值的扩展）进一步增强了配置系统的标准化和灵活性。
...
- 新增 MCP 服务器
  ...
  - 参考
    - [schema.ts:116](file://src/config/schema.ts#L116)
- 新增渠道
