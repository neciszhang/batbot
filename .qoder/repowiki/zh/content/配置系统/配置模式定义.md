...
## 更新摘要
**变更内容**
- 更新代理配置字段：将'agents.default'重命名为'agents.defaults'以更好地反映复数性质
...
**更新** 本版本反映了代理配置字段的重大变更，将'agents.default'重命名为'agents.defaults'以更好地反映复数性质，同时更新了LLM提供者配置参数，包括maxTokens到max_completion_tokens的迁移，以及reasoningEffort枚举值的扩展，同时更新了模块导入以使用Node.js内置模块前缀，提高了代码的兼容性和可维护性。
...
**章节来源**
- [schema.ts:5-168](file://src/config/schema.ts#L5-L168)
...
**章节来源**
- [schema.ts:38-40](file://src/config/schema.ts#L38-L40)
...
**章节来源**
- [schema.ts:44-48](file://src/config/schema.ts#L44-L48)
...
**章节来源**
- [schema.ts:52-57](file://src/config/schema.ts#L52-L57)
...
**章节来源**
- [schema.ts:73-77](file://src/config/schema.ts#L73-L77)
...
**章节来源**
- [schema.ts:61-69](file://src/config/schema.ts#L61-L69)
...
**章节来源**
- [schema.ts:114-120](file://src/config/schema.ts#L114-L120)
...
**章节来源**
- [schema.ts:88-91](file://src/config/schema.ts#L88-L91)
...
**章节来源**
- [schema.ts:81-84](file://src/config/schema.ts#L81-L84)
...
**章节来源**
- [schema.ts:95-98](file://src/config/schema.ts#L95-L98)
...
**章节来源**
- [schema.ts:102-110](file://src/config/schema.ts#L102-L110)
...
**章节来源**
- [schema.ts:124-132](file://src/config/schema.ts#L124-L132)
...
**章节来源**
- [schema.ts:136-167](file://src/config/schema.ts#L136-L167)
...
- 工作区路径解析异常
  ...
  - 参考
    - [schema.ts:159-166](file://src/config/schema.ts#L159-L166)
- 配置字段类型不匹配
  - 现象：运行时报类型错误或字段缺失。
...
- **更新** LLM配置参数问题
  ...
  - 参考
    - [schema.ts:24](file://src/config/schema.ts#L24)
    - [schema.ts:30-33](file://src/config/schema.ts#L30-L33)
...
**更新** 最新的模块导入变更采用了 Node.js 内置模块前缀，提高了代码的兼容性和可维护性，同时保持了原有的功能完整性。LLM提供者配置参数的更新（maxTokens到max_completion_tokens的迁移和reasoning_effort枚举值的扩展）进一步增强了配置系统的标准化和灵活性。代理配置字段从'agents.default'重命名为'agents.defaults'，更好地反映了配置的集合性质和复数特性。
...
- 新增 MCP 服务器
  ...
  - 参考
    - [schema.ts:119](file://src/config/schema.ts#L119)
- 新增渠道
...
- **agents.defaults字段**
  ...
  - 参考
    - [schema.ts:39](file://src/config/schema.ts#L39)
    - [schema.ts:161](file://src/config/schema.ts#L161)
