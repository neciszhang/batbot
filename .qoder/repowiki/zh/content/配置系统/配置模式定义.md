...
**更新** 本版本反映了模块导入从全局模块到 Node.js 内置模块的现代化变更，提高了代码的兼容性和可维护性。
...
**更新** 最新的模块导入变更采用了 Node.js 内置模块前缀，提高了代码的兼容性和可维护性，同时保持了原有的功能完整性。
...
- 新增 MCP 服务器
  ...
  - 参考
    - [schema.ts:113](file://src/config/schema.ts#L113)
- 新增渠道
