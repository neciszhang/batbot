...
**更新** 新增了完整的MessageBus类实现，为代理循环基础设施提供可靠的消息传递支持。
...
- [src/bus/index.ts:1-4](file://src/bus/index.ts#L1-L4)
...
**更新** 新增了MessageBus类的完整实现，包括构造函数初始化和完整的消息处理方法。
...
**更新** 完善了入站消息的sessionKey计算逻辑，支持会话键覆盖功能。
...
**更新** 新增了完整的MessageBus类实现，包括构造函数初始化和完整的消息处理方法。
...
**更新** 完善了异步队列的实现细节，包括私有属性设计和完整的类型安全保证。
...
**更新** 新增了MessageBus类的状态监控功能，包括inboundSize和outboundSize属性。
...
**更新** 新增的MessageBus类提供了更加完善的消息传递基础设施，为代理循环提供了可靠的支持。
